...
const t_op	op_tab[17] =
{
	...
	{XOR, "xor", 3, {T_REG | T_IND | T_DIR, T_REG | T_IND | T_DIR, T_REG, 0}, 6,
		"ou (xor  r1, r2, r3   r1^r2 -> r3", true, true, 4, 3},
	{ZJMP, "zjmp", 1, {T_DIR, 0, 0, 0}, 20, "jump if zero", false, false, 2, 1},
